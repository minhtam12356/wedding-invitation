...
// -----------------------------------------------------------------------
const imageIntroduction = document.createElement("img");
imageIntroduction.setAttribute("width", "100%");
imageIntroduction.setAttribute("src", `./assets/videos/${+queryDate}/1.gif`);
mainIntroductionPosition.appendChild(imageIntroduction);
